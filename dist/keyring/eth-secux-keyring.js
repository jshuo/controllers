...
class SecuxKeyring extends EventEmitter {
    constructor(opts = {}) {
        super();
    ...
    signTransaction(address, tx) {
        ...
        return this._signTransaction(address, tx.common.chainIdBN().toNumber(), unfrozenTx, (payload) => {
    ...
    _signTransaction(address, chainId, tx, handleSigning) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield SecuxConnect.ethereumSignTransaction({
...
exports.SecuxKeyring = SecuxKeyring;
SecuxKeyring.type = keyringType;
//# sourceMappingURL=eth-secux-keyring.js.map